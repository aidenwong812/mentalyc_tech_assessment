...
const List = () => {
    ...
    return (
        <div className="w-full items-center gap-8 flex">
            {
                lists.map((list) => (
            ...
            <p className="md:flex hidden p-4 text-[16px] bg-gradient-to-l from-[#DE0D6F] to-[#731054] bg-clip-text text-transparent ">
                Earn $80
            </p>
        </div>
    )
